  ...
  return (
    <div className="bg-main dark:bg-dmain w-full min-h-screen h-fit flex flex-col px-[30px] pb-[10px]">
      ...
      <div className="mt-[10px] flex flex-col justify-center items-center bg-main dark:bg-dmain pb-[5px] w-full">
        ...
        {/* Tabs */}
        <div className="w-full mt-[60px] mb-[10px] flex justify-center">
          <div className="flex gap-[40px] p-2">
            <button
              onClick={() => setViewMode("list")}
              className={`flex flex-col items-center pb-2 transition ${viewMode === "list"
            ...
            <button
              ...
              className={`flex flex-col items-center pb-2 transition ${viewMode === "map"
                ? "text-txt dark:text-dtxt border-b-2 border-txt dark:border-dtxt"
                : "text-txt2 dark:text-dtxt2"
                }`}
            >
        ...
        {viewMode === "list" ? (
          <div className="w-full flex rounded-xl border border-borderColor dark:border-dborderColor overflow-hidden">
            {/* Left Timeline */}
            <section className="sidebarSection  w-[17%] max-w-[200px] bg-main dark:bg-dmain min-h-screen flex flex-col border-r border-borderColor dark:border-dborderColor">
              <div
                data-label="year section"
                className="archivo leading-none w-full text-txt dark:text-dtxt text-[2.5rem] h-[130px] pb-[20px] pt-[30px] flex justify-center items-center gap-4"
              >
                <button
                  ...
                  <div className="flex flex-col items-center">
                    {Array.from({ length: 12 }, (_, i) => (
                      <div key={i} className="flex flex-col items-center">
                        <div
                          data-label="circle"
                          className={`w-[20px] aspect-square rounded-full border-[2px] flex items-center justify-center ${isCurrentYearRealTime && i === currentMonthIndex
                            ? 'border-orangeMain'
                        ...
                        >
                          <div
                            ...
                            className={`w-[10px] aspect-square rounded-full ${isCurrentYearRealTime && i === currentMonthIndex
                              ? 'bg-orangeMain'
                              : 'bg-transparent'
                              }`}
                          ></div>
                        ...
                        {i < 11 && (
                          <div
                            data-label="vertLine"
                            className={`h-[200px] ${isCurrentYearRealTime && i === currentMonthIndex
